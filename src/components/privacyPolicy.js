        ...
        return (
            <div className="App dark container">
                <Layout>
                    ...
                    <Content>
                        <div className="main te-left" id="policy">
                            <h1 className="mt-5">Privacy Policy</h1>
                            <p>Your privacy is important to us. It is vikram’s policy to respect your privacy regarding any information we may collect from you across our website, <a href="https://vikram.com">http://vikram.com</a>, and other sites we own and operate.</p>
                            ...
                            <p>This privacy policy only covers vikram’s own collecting and handling of data. We only work with partners, affiliates and third-party providers whose privacy policies align with ours, however we cannot accept responsibility or liability for their respective privacy practices.</p>
                            ...
                            <h2 id="your-rights-and-responsibilities">Your rights and responsibilities</h2>
                            ...
                            <p><strong>Mail us at : </strong><a href="mailto:vkpandit1909@gmail.com">vkpandit1909@gmail.com</a></p><p>This policy is effective as of February 3, 2021.</p>
                        </div>
                    </Content>
                    <Footer>
                        <FooterContent />
